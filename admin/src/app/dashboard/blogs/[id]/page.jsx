...
import DeleteBlog from "@/components/blogs/DeleteBlogs";
import KeepBlog from "@/components/blogs/KeepBlog";
...
export default async function BlogContent({ params }) {
  try {
    ...
    if (blog.length === 0) {
      return (
        <div className="px-4 my-32 md:px-10 lg:px-12 xl:px-24 ">
    ...
    return (
      <div className=" max-w-[1600px] mb-7">
        <div key={blog._id}>
          <div className="pt-8">
            <div className="flex justify-center">
              <Badge className="px-3 py-1 m-2 font-normal rounded-xl bg-greenscape">
                {blog.category}
              </Badge>
            </div>
          ...
          <div className="px-6 md:px-10 lg:px-12 xl:px-24 md:flex ">
            <div className="hidden md:block md:w-1/4 md:pr-4">
              <Badge className="px-3 py-1font-normal rounded-xl bg-greenscape">
                {blog.category}
              </Badge>
            </div>
