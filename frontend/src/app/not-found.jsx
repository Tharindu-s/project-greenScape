...
const NotFound = () => {
  return (
    <div>
      <section clasName="">
        <div clasName="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div clasName="w-full flex-col justify-start items-center lg:gap-16 gap-10 inline-flex lg:pt-[180px] pt-12 lg:pb-28 pb-12">
            <div clasName="border border-indigo-300 h-[550px] rounded-lg w-full">
              <div clasName="p-8 flex justify-between items-center border-b border-indigo-100">
                <div clasName="block">
                  <svg
                    width="204"
                    height="18"
              ...
              <div clasName="relative h-[calc(550px-85px)] flex justify-center items-center flex-col">
                <svg
                  width="314"
                  height="171"
                  viewBox="0 0 314 171"
                ...
                <div clasName="block text-center mt-5">
                  <h5 clasName="md:text-xl text-lg leading-8 text-gray-900 font-medium mb-1.5">
                    <span clasName="text-indigo-600 font-semibold ">Oops!</span>{" "}
                    It seems like you've taken a wrong turn
                  </h5>
                  <p clasName="text-sm text-gray-500">
